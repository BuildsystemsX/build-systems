...
import sty from "./PlasmicObservable.module.css"; // plasmic-import: qfo7886Wwu/css
  ...
  return (
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <Embed
            className={classNames("__wab_instance", sty.embedHtml__nwpc9)}
            code={
          ...
          <Iframe
            ...
            preview={true}
            src={
              "https://observablehq.com/embed/@ramonweber/buildingforzero?cells=chart%2Cgraph%2Cviewof+col2%2Cviewof+col1%2Cviewof+scenario_text%2Cviewof+ssp_text%2Cviewof+buildings_emissions%2Cviewof+heading_text" as const
            }
          />
          ...
          <Embed
            className={classNames("__wab_instance", sty.embedHtml__xjkGc)}
            code={"" as const}
          />
        </div>
      </div>
